...
export default function DownloadSection(){
    return <div className="flex mb-40 justify-center items-center gap-5 flex-col" >
        ...
        <p className=" text-center w-120 text-[#b2b2b2]" >We've got more browsers in the pipeline. Please do let us know if you've got a favourite you'd like us to prioritize.</p>
        <div className=" space-x-7 flex md:flex-row flex-col" >
...
function Card({img, h1, p, style}){
    return <div className={` ${style}  rounded-lg py-6 px-6  gap-5 shadow-lg justify-center items-center flex flex-col w-full md:w-1/3 `}>
        ...
        <button className="  border-2 border-[#5368e2] hover:text-[#5368e2] hover:bg-white rounded-md text-white py-3 px-12 bg-[#5368e2] self-start" >Add & Install Extension</button>
    </div>
}